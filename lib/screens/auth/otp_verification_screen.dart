...
class _OTPVerificationScreenState extends State<OTPVerificationScreen> {
  ...
  String _infoText = 'Enter the verification code sent to your email.';
  ...
  Future<void> _checkVerification() async {
    ...
    if (user != null && user.emailVerified) {
      setState(() {
        _isVerified = true;
        _infoText = 'Email verified! Redirecting...';
      });
      ...
      setState(() {
        _infoText = 'Not verified yet. Please check your email.';
      });
    }
  ...
  Future<void> _resendVerification() async {
    ...
    try {
      ...
      setState(() {
        _infoText = 'Verification email resent!';
      });
    } catch (e) {
      setState(() {
        _infoText = 'Failed to resend verification email.';
      });
    }
    setState(() => _isLoading = false);
  }
